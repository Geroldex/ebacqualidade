...
Cenário: Concluir Cadastro para Finalizar Compra
    ...
    Quando preencho todos os campos obrigatórios corretamente e clico no botão de concluir cadastro
    Então devo ser redirecionado para a finalização da compra

Cenário: Tentar Concluir Cadastro com E-mail Inválido
  
    Quando preencho o campo de e-mail com um formato inválido E clico no botão de concluir cadastro
